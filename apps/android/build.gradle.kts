...
android {
    ...
    defaultConfig {
        applicationId = "com.photoprism.uploader"
        minSdk = 29
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
    ...
    buildTypes {
        create("experiment") {
            ...
            buildConfigField("String", "DEFAULT_SERVER_URL", "\"http://127.0.0.1:8788/import/\"")
            buildConfigField("String", "DEFAULT_USERNAME", "\"synthetic\"")
...
dependencies {
    ...
    "experimentImplementation"("androidx.compose.ui:ui-test-manifest")
