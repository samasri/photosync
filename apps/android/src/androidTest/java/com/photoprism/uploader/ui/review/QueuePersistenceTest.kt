...
class QueuePersistenceTest {
    @Test fun cachedPhotoSurvivesSourceRemovalAndWorkerRetries(): Unit = runBlocking {
        ...
        val fixture = File(context.filesDir, "queue-fixture.jpg")
        ...
        bitmap.recycle()
        val image = MediaImage(99999, Uri.fromFile(fixture), fixture.name, fixture.length(), "test", 1788220800L)
        ...
        try {
            ...
            if (!sourceDeleted) fixture.delete()
            server.shutdown()
        }
    }
