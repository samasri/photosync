...
fun SettingsScreen(viewModel: SettingsViewModel, onBack: () -> Unit) {
    ...
    Scaffold(topBar = {
        ...
        LazyColumn(Modifier.fillMaxSize().padding(padding).padding(horizontal = 16.dp),
            ...
            item {
                HorizontalDivider()
                Text("WhatsApp · Review progress", style = MaterialTheme.typography.titleMedium)
                Text("Review tracking starts January 1, 2026")
                Text("Photos already present before this date are untracked. Older photos added later still appear for review.")
